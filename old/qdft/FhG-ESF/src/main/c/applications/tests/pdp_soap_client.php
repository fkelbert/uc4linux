...
<!-- Observation mechanism evaluates formula, 
     when formula is violated (is false) then
     actions are executed -->

<!-- Control mechanism checks for trigger,
     if condition is true,
     then enforcement actions are executed -->
<preventiveMechanism name="ExampleControl">
  ...
  try
  {    
      $result = $client->__call("deployPolicy",$parameters,array("uri" => "urn:pdp","soapaction" => "urn:pdp#deployPolicy")); // soapaction not really necessary
  }
  catch(Exception $e)
  {
