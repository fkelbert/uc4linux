...
public class dataManagers : IDisposable {
  ...
  public void remove(string d, uint q, string c) {
    libqdftgraphPINVOKE.dataManagers_remove(swigCPtr, d, q, c);
    if (libqdftgraphPINVOKE.SWIGPendingException.Pending) throw libqdftgraphPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void revert_last_transfer(string d) {
    libqdftgraphPINVOKE.dataManagers_revert_last_transfer(swigCPtr, d);
    if (libqdftgraphPINVOKE.SWIGPendingException.Pending) throw libqdftgraphPINVOKE.SWIGPendingException.Retrieve();
  }
