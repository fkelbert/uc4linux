...
#define policyFileName "/home/user/Desktop/running/policies/pdpPolicy.xml"
#define defaultPolicyFile "/home/user/Desktop/running/policies/defaultPolicy.xml"
#define APPLICATION_PATH "/usr/bin/gnome-terminal"
 ...
 */
void printUsage(){
	fprintf(stderr,"This program should be executed the following way:\n"
